...
var KW  = [
		...
		"REPLACE", "INTO", "SET",
		"SELECT", "CONSISTENT_READ","FROM", "WHERE", "BEGINS_WITH", "BETWEEN", "AND", "HAVING", "DESC", "LIMIT",
		"DELETE","FROM","WHERE",
		"CREATE","TABLE"
	]
...
SqlParser.split_select = function($query) {
	...
	var $split = SqlParser.array_split($q,  ['SELECT','CONSISTENT_READ','FROM','WHERE','HAVING','DESC','LIMIT'] )
