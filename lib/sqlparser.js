...
var OP = ["INSERT","UPDATE","REPLACE","SELECT","DELETE","CREATE","SHOW"]
...
SqlParser.split_create_table = function($query) {
	...
	//var $split = SqlParser.array_split($q,  ['CREATE','TABLE','NUMBER','STRING','PRIMARY','KEY','INDEX','GSI','LSI'] )
	var $split = SqlParser.array_split($q,  ['CREATE','TABLE'] )
